...
## 🔥 Phase 4: 긴급 수정 사항 (11월 11-12일, 1일)

### 4.1 당선 기준 표시 수정 ⭐⭐⭐ (즉시, 10분)
...
**수정 내용:**
- [ ] 결과 페이지: `max_selections` 값만큼 상위 N명을 당선자로 표시
- [ ] 모니터링 페이지: 상위 N명 강조 표시
- [ ] 문구 변경: "득표 1위 당선" → "상위 2명 당선" (동적)
- [ ] 당선자 배지: 1위, 2위 등 순위 표시
...
|------|-------|-----------|-----------|------|
| **11/11 (월)** | Phase 4 | 당선 기준 수정 | 0.5일 | 0.5일 |
